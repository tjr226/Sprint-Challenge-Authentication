...
Letting people access an API or website without having to re-login every time

1. What does bcrypt do to help us store passwords in a secure manner.

Hashes the passwords so we don't store in plaintext (and probably lots more)
